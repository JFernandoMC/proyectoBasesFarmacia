          ...
          <div class="card-body">
            <form action="<?=URL?>productos/nuevo" method="POST">
              <div class="form-group">
                ...
                <input type="text" class="form-control"   name='codPro'aria-describedby="emailHelp">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control"  name='precioVen' aria-describedby="emailHelp">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Precio Compra</label>
                <input type="text" class="form-control" name='precioCom'  aria-describedby="emailHelp">
